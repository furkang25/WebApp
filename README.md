...
- ja, bestimmte Paketversionen
- bestimmte Befehle werden später bereitgestellt
- Server muss nicht gestoppt/gestartet werden
- Führe folgende Befehle aus, um React 19 zu entfernen und React 18 zu installieren
